...
class UltraSuperCalculator:
    ...
    def store_value_to_register(self, value_to_store):
        ...
        print(int(value_to_store, 2), " is stored in register", self.numbers_index)
        self.numbers_index += 1

    def load_value_from_regsiter(self, register_address):
    ...
    def add(self, address_num1, address_num2):
        num1 = self.load_value_from_regsiter(address_num1)
        num2 = self.load_value_from_regsiter(address_num2)
